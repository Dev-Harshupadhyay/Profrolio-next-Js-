  ...
  const projectsData = [
    {
      id: "cinevood",
      title: "Cinevood",
      description: "A movie discovery and browsing web app",
      category: "project" as const,
      icon: <Briefcase className="mr-2 h-4 w-4" />,
      action: () => window.open("https://cinenvood.onrender.com", "_blank")
    },
    {
      id: "tarazu",
      title: "Tarazu",
      description: "A handy calculator / utility web app",
      category: "project" as const,
      icon: <Briefcase className="mr-2 h-4 w-4" />,
      action: () => window.open("https://tarzau.netlify.app", "_blank")
    },
    {
      id: "climatek",
      title: "ClimaTek",
      ...
      category: "project" as const,
      icon: <Briefcase className="mr-2 h-4 w-4" />,
      action: () => window.open("https://climatek.netlify.app", "_blank")
    },
  ];
    ...
    <>
      ...
      <CommandList className={isMobile ? "max-h-none flex-1 overflow-y-auto" : undefined}>
        ...
        <CommandGroup heading="Actions">
          <CommandItem onSelect={() => {
            window.open('https://drive.google.com/file/d/1M47X-gCa-cjSFUMKYzSWb88e1cY5xAkn/view?usp=drivesdk', '_blank');
            setOpen(false);
          }}>
          ...
          <CommandItem onSelect={() => {
            window.open("https://github.com/Dev-Harshupadhyay", "_blank");
            setOpen(false);
          }}>
          ...
          <CommandItem onSelect={() => {
            window.open("https://www.linkedin.com/in/harsh-upadhyay-a014783b4", "_blank");
            setOpen(false);
          }}>
