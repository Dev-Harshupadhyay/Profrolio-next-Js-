      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white">harsh.dev</h3>
            <p className="text-gray-400">
              Building clean, modern web experiences. BCA 1st semester student and passionate full-stack developer.
            </p>
            <div className="flex gap-3">
              <a
                href="https://www.linkedin.com/in/harsh-upadhyay-a014783b4"
                target="_blank"
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-6 space-y-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">
                Open to internships and collaboration opportunities. Let's build something great together.
              </p>
              <a
                href="mailto:harsh48227@gmail.com"
                className="text-sm text-white hover:text-blue-400 flex items-center gap-2 transition-colors"
              >
                harsh48227@gmail.com
