...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const sections = ["hero", "about", "projects", "faq"];
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Left - Logo */}
          <Link href="/" className="text-xl font-bold z-10 flex-shrink-0">
            <span className="text-foreground whitespace-nowrap">harsh</span>
            <span className="text-muted-foreground whitespace-nowrap">.dev</span>
          </Link>
